...
public enum XenonGLExtension {
	...
	private XenonGLExtension(String string, boolean value) {
		this.string = string;
		this.present = value;
	}
	 ...
	 */
	public static XenonGLExtension parseAndFlag(String input) {
		for (XenonGLExtension item : values()) {
