 ...
 */
object InterpolationQuintInOut : Interpolation {
    ...
    override fun getPercentage(pSecondsElapsed: Float, pDuration: Float): Float {
        ...
        return if (percentage < 0.5f) {
            0.5f * InterpolationQuintIn.Companion.getValue(2 * percentage)
        } else {
            0.5f + 0.5f * InterpolationQuintOut.getValue(percentage * 2 - 1)
        }
    }
}