 ...
 */
object InterpolationCircularInOut : Interpolation {
    ...
    override fun getPercentage(pSecondsElapsed: Float, pDuration: Float): Float {
        ...
        return if (percentage < 0.5f) {
            0.5f * InterpolationCircularIn.Companion.getValue(2 * percentage)
        } else {
            0.5f + 0.5f * InterpolationCircularOut.getValue(percentage * 2 - 1)
        }
    }
}