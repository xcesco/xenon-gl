...
object Fusion2OrientationProvider : OrientationProvider() {
    ...
    override fun onSensorChanged(event: SensorEvent) {
        when (event.sensor.type) {
            ...
            Sensor.TYPE_GYROSCOPE ->            // Process Gyroscope and perform fusion
                ...
                if (timestamp != 0L) {
                    ...
                    if (Math.abs(dotProd) < OUTLIER_THRESHOLD) {
                        ...
                        quaternionGyroscope.slerp(quaternionRotationVector, interpolate, (INDIRECT_INTERPOLATION_WEIGHT * gyroscopeRotationVelocity).toFloat())
